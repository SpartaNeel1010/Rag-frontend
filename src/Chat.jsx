...
function Chat({activeIndex,chats,setChats}) {
  ...
  const handleSubmit = async (e) => {
    ...
    const newChat = { "question": query, "index_name":activeIndex };
    console.log(newChat)
    setQuery("")
    ...
    try {
      const response = await fetch('https://backend-service-640388342610.us-central1.run.app/generate', {
        method: 'POST',
        headers: {
